...
func init() {
	...
	cfgParams := []config.Param{
		...
		{Name: "watch-xlsx", Value: "/tmp/source/xlsx", Usage: "path to watch for xlsx", ViperBind: "Watcher.Path.XLSX"},
		{Name: "watch-formstruct", Value: "/tmp/source/formstruct", Usage: "path to watch for formstruct", ViperBind: "Watcher.Path.FormStruct"},
